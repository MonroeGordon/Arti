...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    static bool show_app_communicator = false;
    ...
    if (show_app_communicator)        ShowExampleAppConsole(&show_app_communicator);
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Examples"))
        {
            ...
            ImGui::MenuItem("Console", NULL, &show_app_communicator);
...
// Demonstrate creating a simple communicator window, with scrolling, filtering, completion and history.
// For the communicator example, we are using a more C++ like approach of declaring a class to hold both data and functions.
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        ImGui::TextWrapped(
            "This example implements a communicator with basic coloring, completion (TAB key) and history (Up/Down keys). A more elaborate "
    ...
    {
        ExampleAppConsole* communicator = (ExampleAppConsole*)data->UserData;
        return communicator->TextEditCallback(data);
    }
...
static void ShowExampleAppConsole(bool* p_open)
{
    static ExampleAppConsole communicator;
    communicator.Draw("Example: Console", p_open);
}
